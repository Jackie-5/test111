...
export default function keepAliveDecorator(Component) {
    var TriggerLifecycleContainer = /** @class */ (function (_super) {
        ...
        TriggerLifecycleContainer.prototype.componentWillUnmount = function () {
            var eventEmitter = this.props._keepAliveContextProps.eventEmitter;
        ...
        TriggerLifecycleContainer.prototype.render = function () {
            var _a = this.props, propKey = _a.propKey, keepAlive = _a.keepAlive, _b = _a._keepAliveContextProps, isExisted = _b.isExisted, storeElement = _b.storeElement, cache = _b.cache, eventEmitter = _b.eventEmitter, setCache = _b.setCache, unactivate = _b.unactivate, providerIdentification = _b.providerIdentification, wrapperProps = __rest(_a, ["propKey", "keepAlive", "_keepAliveContextProps"]);
            ...
            var _c = this, isNeedActivate = _c.isNeedActivate, notNeedActivate = _c.notNeedActivate, getLifecycle = _c.getLifecycle, setLifecycle = _c.setLifecycle, identification = _c.identification, ifStillActivate = _c.ifStillActivate;
    ...
    var ListenUpperKeepAliveContainer = /** @class */ (function (_super) {
        ...
        ListenUpperKeepAliveContainer.prototype.listenUpperKeepAlive = function () {
            ...
            eventEmitter.on([identification, COMMAND.MOUNT], this.mount = function () { return _this.setState({ activated: true }); }, true);
        ...
        ListenUpperKeepAliveContainer.prototype.render = function () {
            ...
            var combinedKeepAlive = getLifecycle === undefined || getLifecycle() === LIFECYCLE.UPDATING
                ? newKeepAlive
                : identification
                    ? upperKeepAlive && newKeepAlive
                    : newKeepAlive;
            return activated
                ? (React.createElement(TriggerLifecycleContainer, __assign({}, wrapperProps, { propKey: propKey, keepAlive: combinedKeepAlive })))
                : null;
        };
